function [rank_point,normal_vector,target_point,shift_x,shift_y,shift_z]=ProcessBoatElement(Param,Observe, a, b)
...
target_point = Param.boat.target_point;
target_rank = Param.boat.target_rank;
